...
# Display header
echo "====================================="
echo "        DISCORD BOT MAKER            "
echo "        Written by NotSkeppyOg       "
echo "====================================="
...
while true; do
    ...
    if [ "$choice" == "1" ]; then
        # VPS Bot flow
        echo "Creating VPS Bot..."

        # Create requirements.txt with predefined dependencies
...
EOL
        ...
        # Create bot.py with full code already included
        echo "Creating bot.py with embedded code..."
        cat > bot.py <<EOL
import discord
...
EOL
        ...
        read -p "Enter Admin Role ID: " admin_role_id
...
EOL
        ...
        # Create system user for docker
        echo "Creating unixnodes user and adding to docker group..."
